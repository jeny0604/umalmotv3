...
import PbItem11 from './PbItem11';
import HintItem from './HintItem';
import PlayMusic11 from './PlayMusic11';

class Problem11 extends React.Component {
   render() {
    return (
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic11 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem11 itemImage={require('./img/90/castle.png')}/>
              <PbItem11 itemImage={require('./img/90/confess.png')} />
              <PbItem11 itemImage={require('./img/90/dance.png')} />
              <PbItem11 itemImage={require('./img/90/love.png')} />
              <PbItem11 itemImage={require('./img/90/tears.png')} />
