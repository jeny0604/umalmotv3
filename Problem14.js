...
import PbItem14 from './PbItem14';
import HintItem from './HintItem';
import PlayMusic14 from './PlayMusic14';

class Problem14 extends React.Component {
   render() {
    return (
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic14 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem14 itemImage={require('./img/90/violoet.png')}/>
              <PbItem14 itemImage={require('./img/90/nun.png')} />
              <PbItem14 itemImage={require('./img/90/manam.png')} />
              <PbItem14 itemImage={require('./img/90/tears.png')} />
              <PbItem14 itemImage={require('./img/90/dance.png')} />
