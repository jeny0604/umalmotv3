...
import PbItem5 from './PbItem5';
import HintItem from './HintItem';
import PlayMusic5 from './PlayMusic5';
        ...
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic5 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem5 itemImage={require('./img/00/geebt.png')}/>
              <PbItem5 itemImage={require('./img/00/miabt.png')} />
              <PbItem5 itemImage={require('./img/00/hotbt.png')} />
              <PbItem5 itemImage={require('./img/00/miroticbt.png')} />
              <PbItem5 itemImage={require('./img/00/tellbt.png')} />
