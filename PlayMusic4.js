...
export default class PlayMusic4 extends React.Component{
    render(){
        return(
            ...
            onPress={()=>{
                ...
                try {
                    (async ()=> {
                        await soundObject.loadAsync(require('./sounds/idontcare_short.mp3'));
...
AppRegistry.registerComponent('PlayMusic4',()=>PlayMusic4);
