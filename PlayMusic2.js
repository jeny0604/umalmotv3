...
export default class PlayMusic2 extends React.Component{
    render(){
        return(
            ...
            onPress={()=>{
                ...
                try {
                    (async ()=> {
                        await soundObject.loadAsync(require('./sounds/HaruHaru_short.mp3'));
...
AppRegistry.registerComponent('PlayMusic2',()=>PlayMusic2);
