...
import PbItem2 from './PbItem2';
import HintItem from './HintItem';
import PlayMusic2 from './PlayMusic2';
        ...
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic2 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem2 itemImage={require('./img/00/harubt.png')}/>
              <PbItem2 itemImage={require('./img/00/sorrybt.png')} />
              <PbItem2 itemImage={require('./img/00/nabibt.png')} />
              <PbItem2 itemImage={require('./img/00/10minbt.png')} />
              <PbItem2 itemImage={require('./img/00/sojubt.png')} />
