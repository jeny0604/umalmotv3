...
import PbItem24 from './PbItem24';
import HintItem from './HintItem';
import PlayMusic24 from './PlayMusic24';

class Problem24 extends React.Component {
   render() {
    return (
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic24 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem24 itemImage={require('./img/10/end.png')}/>
              <PbItem24 itemImage={require('./img/10/growl.png')} />
              <PbItem24 itemImage={require('./img/10/cheer.png')} />
              <PbItem24 itemImage={require('./img/10/iamthebest.png')} />
              <PbItem24 itemImage={require('./img/10/girl.png')} />
