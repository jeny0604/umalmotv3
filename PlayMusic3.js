...
export default class PlayMusic3 extends React.Component{
    render(){
        return(
            ...
            onPress={()=>{
                ...
                try {
                    (async ()=> {
                        await soundObject.loadAsync(require('./sounds/10Minutes_short.mp3'));
...
AppRegistry.registerComponent('PlayMusic3',()=>PlayMusic3);
