...
export default class PlayMusic5 extends React.Component{
    render(){
        return(
            ...
            onPress={()=>{
                ...
                try {
                    (async ()=> {
                        await soundObject.loadAsync(require('./sounds/MIROTIC_short.mp3'));
...
AppRegistry.registerComponent('PlayMusic5',()=>PlayMusic5);
