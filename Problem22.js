...
import PbItem22 from './PbItem22';
import HintItem from './HintItem';
import PlayMusic22 from './PlayMusic22';

class Problem22 extends React.Component {
   render() {
    return (
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic22 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem22 itemImage={require('./img/10/girl.png')}/>
              <PbItem22 itemImage={require('./img/10/growl.png')} />
              <PbItem22 itemImage={require('./img/10/crayon.png')} />
              <PbItem22 itemImage={require('./img/10/iu.png')} />
              <PbItem22 itemImage={require('./img/10/whats.png')} />
