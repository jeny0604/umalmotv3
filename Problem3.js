...
import PbItem3 from './PbItem3';
import HintItem from './HintItem';
import PlayMusic3 from './PlayMusic3';
        ...
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic3 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem3 itemImage={require('./img/00/pwbt.png')}/>
              <PbItem3 itemImage={require('./img/00/cowardbt.png')} />
              <PbItem3 itemImage={require('./img/00/harubt.png')} />
              <PbItem3 itemImage={require('./img/00/miroticbt.png')} />
              <PbItem3 itemImage={require('./img/00/10minbt.png')} />
