...
import PbItem13 from './PbItem13';
import HintItem from './HintItem';
import PlayMusic13 from './PlayMusic13';

class Problem13 extends React.Component {
   render() {
    return (
        <ImageBackground
          ...
          <View style={styles.descrption}>
             ...
             <View style={styles.descrptionBottom}>
                <PlayMusic13 itemImage={require('./img/play.png')} style={styles.playbuSt}/>
                <ImageBackground
          ...
          <View style={styles.element}>
            <View style={styles.proContainer}>
              <PbItem13 itemImage={require('./img/90/dance.png')}/>
              <PbItem13 itemImage={require('./img/90/nobrain.png')} />
              <PbItem13 itemImage={require('./img/90/love.png')} />
              <PbItem13 itemImage={require('./img/90/confess.png')} />
              <PbItem13 itemImage={require('./img/90/violoet.png')} />
